...
// assets
import { Mail, Photo, Storefront } from "@mui/icons-material";
        ...
        <ListItem alignItems="center">
          <ListItemAvatar>
            ...
            >
              ...
              <Storefront sx={{ fontSize: "1.3rem", stroke: 1.5 }} />
            </Avatar>
          </ListItemAvatar>
          <ListItemText
            primary={
        ...
        <ListItem alignItems="center">
          <ListItemAvatar>
            ...
            >
              ...
              <Mail sx={{ fontSize: "1.3rem", stroke: 1.5 }} />
            </Avatar>
          </ListItemAvatar>
          <ListItemText
            primary={
                    ...
                    <Grid container direction="column">
                      <Grid item xs={12}>
                        <Stack direction="row" spacing={2}>
                          ...
                          <Photo sx={{ fontSize: "1.3rem", stroke: 1.5 }} />
