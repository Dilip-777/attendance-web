  ...
  return (
    ...
    >
      ...
      <Autocomplete
        ...
        // value={options.find((c) => c.value === field.value)?.value}
        // onChange={(e, value) => setFieldValue(name, value?.value as string)}
        // onChange={(e, value) => setSelectedContractor(value?.value as string)}
        clearIcon={null}
